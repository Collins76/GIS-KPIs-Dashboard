...
export const kpis: Kpi[] = [
  ...
  { id: 'SPEC-04', role: 'GIS Specialist', title: 'Resolve 100% of GIS technical issues within 24 hours.', category: 'Customer', target: '24h', metric: 'Avg. Resolution Time', dataSource: 'Helpdesk Tickets', progress: 0, status: 'Not Started', weight: 20, targetType: 'Number', frequency: 'Monthly', startDate: '2025-01-01', endDate: '2025-12-31' },
  ...
  { id: 'ANLST-04', role: 'GIS Analyst', title: 'Resolve 100% of GIS technical issues within 24 hours.', category: 'Customer', target: '24h', metric: 'Response Time', dataSource: 'Email/Helpdesk', progress: 0, status: 'Not Started', weight: 15, targetType: 'Number', frequency: 'Monthly', startDate: '2025-01-01', endDate: '2025-12-31' },
