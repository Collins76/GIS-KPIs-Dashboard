...
export const kpis: Kpi[] = [
  ...
  // GIS Lead
  { id: 'LEAD-01', role: 'GIS Lead', title: 'Complete 100% of GIS projects within agreed timelines to support organizational objectives', category: 'Operational Process', target: '100', metric: 'Project Completion Rate', dataSource: 'JIRA', progress: 0, status: 'Not Started', weight: 15, targetType: 'Percentage', frequency: 'Monthly', startDate: '2025-01-01', endDate: '2025-12-31' },
  { id: 'LEAD-02', role: 'GIS Lead', title: 'Provide technical and mentorship training to GIS Specialists and Analysts.', category: 'People Development', target: '4', metric: 'Workshops Held', dataSource: 'Training Calendar', progress: 0, status: 'Not Started', weight: 15, targetType: 'Number', frequency: 'Quarterly', startDate: '2025-01-01', endDate: '2025-12-31' },
  { id: 'LEAD-03', role: 'GIS Lead', title: 'Ensure the accuracy and quality of all GIS data and map products delivered by the team.', category: 'Operational Process', target: '20', metric: 'Error Rate < 1%', dataSource: 'QC Logs', progress: 0, status: 'Not Started', weight: 10, targetType: 'Percentage', frequency: 'Monthly', startDate: '2025-01-01', endDate: '2025-12-31' },
  { id: 'LEAD-04', role: 'GIS Lead', title: 'Full integration of GIS data to ensure 100% accuracy in capturing all IE network assets.', category: 'Operational Process', target: '100', metric: 'Asset Capture %', dataSource: 'Asset Register', progress: 0, status: 'Not Started', weight: 20, targetType: 'Percentage', frequency: 'Monthly', startDate: '2025-01-01', endDate: '2025-12-31' },
  { id: 'LEAD-05', role: 'GIS Lead', title: 'Identifies and implement one outstanding new technologies to improve network efficiency and reliability.', category: 'Business Growth', target: '1', metric: 'Tech Pilot', dataSource: 'R&D Reports', progress: 0, status: 'Not Started', weight: 20, targetType: 'Number', frequency: 'Annually', startDate: '2025-01-01', endDate: '2025-12-31' },
  // GIS Specialist
  { id: 'SPEC-01', role: 'GIS Specialist', title: 'Complete 100% of GIS projects within agreed timelines to support organizational objectives.', category: 'Operational Process', target: '100', metric: 'Task Completion', dataSource: 'Asana', progress: 0, status: 'Not Started', weight: 15, targetType: 'Percentage', frequency: 'Monthly', startDate: '2025-01-01', endDate: '2025-12-31' },
  { id: 'SPEC-02', role: 'GIS Specialist', title: 'Provide technical and mentorship training to GIS Analysts.', category: 'People Development', target: '4', metric: 'Mentees Supported', dataSource: 'Mentorship Program', progress: 0, status: 'Not Started', weight: 15, targetType: 'Number', frequency: 'Quarterly', startDate: '2025-01-01', endDate: '2025-12-31' },
  { id: 'SPEC-03', role: 'GIS Specialist', title: 'Full integration of GIS data to ensure 100% accuracy in capturing all IE network assets.', category: 'Operational Process', target: '100', metric: 'Data Integrity Score', dataSource: 'Database Audits', progress: 0, status: 'Not Started', weight: 20, targetType: 'Percentage', frequency: 'Monthly', startDate: '2025-01-01', endDate: '2025-12-31' },
  { id: 'SPEC-04', role: 'GIS Specialist', title: 'Resolve 100% of GIS technical issues within 24 hours.', category: 'Customer', target: '100', metric: 'Avg. Resolution Time', dataSource: 'Helpdesk Tickets', progress: 0, status: 'Not Started', weight: 10, targetType: 'Percentage', frequency: 'Weekly', startDate: '2025-01-01', endDate: '2025-12-31' },
  { id: 'SPEC-05', role: 'GIS Specialist', title: 'Identifies and implement one outstanding new technologies to improve network efficiency and reliability.', category: 'Business Growth', target: '1', metric: 'Proposals Submitted', dataSource: 'Internal Submissions', progress: 0, status: 'Not Started', weight: 20, targetType: 'Number', frequency: 'Annually', startDate: '2025-01-01', endDate: '2025-12-31' },
  // Geodatabase Specialist
  { id: 'GEO-01', role: 'Geodatabase Specialist', title: 'Ensure the integrity, security, and optimal performance of the enterprise geodatabase.', category: 'Operational Process', target: '100', metric: 'DB Uptime', dataSource: 'Server Logs', progress: 0, status: 'Not Started', weight: 20, targetType: 'Percentage', frequency: 'Weekly', startDate: '2025-01-01', endDate: '2025-12-31' },
  { id: 'GEO-02', role: 'Geodatabase Specialist', title: 'Provide technical and mentorship training to GIS Analysts.', category: 'People Development', target: '4', metric: 'Docs Created', dataSource: 'Confluence', progress: 0, status: 'Not Started', weight: 10, targetType: 'Number', frequency: 'Quarterly', startDate: '2025-01-01', endDate: '2025-12-31' },
  { id: 'GEO-03', role: 'Geodatabase Specialist', title: 'Ensure the accuracy and quality of all GIS data during maintenance window with the commercial department.', category: 'Operational Process', target: '20', metric: 'Data Loss Incidents', dataSource: 'Backup Logs', progress: 0, status: 'Not Started', weight: 10, targetType: 'Percentage', frequency: 'Monthly', startDate: '2025-01-01', endDate: '2025-12-31' },
  { id: 'GEO-04', role: 'Geodatabase Specialist', title: 'Full integration of GIS data to ensure 100% accuracy in capturing all IE network assets.', category: 'Operational Process', target: '100', metric: 'Sync Status', dataSource: 'ETL Logs', progress: 0, status: 'Not Started', weight: 20, targetType: 'Percentage', frequency: 'Monthly', startDate: '2025-01-01', endDate: '2025-12-31' },
  { id: 'GEO-05', role: 'Geodatabase Specialist', title: 'Identifies and implement one outstanding new technologies to improve network efficiency and reliability.', category: 'Business Growth', target: '1', metric: 'Optimizations Implemented', dataSource: 'Change Log', progress: 0, status: 'Not Started', weight: 20, targetType: 'Number', frequency: 'Annually', startDate: '2025-01-01', endDate: '2025-12-31' },
  // GIS Analyst
  { id: 'ANLST-01', role: 'GIS Analyst', title: 'Capture, process, and integrate spatial and non-spatial data from various sources into the GIS database.', category: 'Operational Process', target: '100', metric: 'Assets Processed', dataSource: 'Data Entry Logs', progress: 0, status: 'Not Started', weight: 20, targetType: 'Percentage', frequency: 'Weekly', startDate: '2025-01-01', endDate: '2025-12-31' },
  ...
  { id: 'ANLST-03', role: 'GIS Analyst', title: 'Full integration of GIS data to ensure 100% accuracy in capturing all IE network assets.', category: 'Operational Process', target: '100', metric: 'Sync Rate', dataSource: 'Field App Logs', progress: 0, status: 'Not Started', weight: 10, targetType: 'Percentage', frequency: 'Weekly', startDate: '2025-01-01', endDate: '2025-12-31' },
